...
function Location:DrawTitle(position, scale)
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) + (Vector2.Left * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) + (Vector2.One * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) + (Vector2.Up * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) + (Vector2.Right * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) - (Vector2.One * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
	Render:DrawText( position - (Render:GetTextSize(self.name, TextSize.VeryLarge * scale) / 2) + (Vector2.Down * (Location.Icon.Size.y / 2) * scale) + (Vector2.Down * TextSize.VeryLarge * scale / 2) + (Vector2.Down * scale * 2), self.name, Color.Black, TextSize.VeryLarge, scale )
...
Map = {
	...
	Marker = Image.Create( AssetLocation.Base64, "" ),
...
function Map:Draw()
	...
	if ramka then
		Render:FillArea( Map.Image:GetPosition() - Vector2( 5, 5 ), Map.Image:GetSize() + Vector2( 5, 5 )*2, Color( 173, 216, 230, 100 ) )
	end
	Map.Image:Draw()
	...
	if rendermap then
		...
		for _, player in pairs( players ) do
			if player.id ~= LocalPlayer:GetId() and player.worldId == LocalPlayer:GetWorld():GetId() then
				...
				Render:DrawCircle( position, Render.Size.y * 0.0065, Color.Black )
				Render:FillCircle( position, Render.Size.y * 0.006, player.col )
		...
		if InitTimer then
			if InitTimer:GetSeconds() >= 1 then
				self.position = Map:WorldToScreen( LocalPlayer:GetPosition() )
				InitTimer = nil
			end
		end	

		if CircleTimer or FadeInTimer or FadeOutTimer or DelayTimer then
			if CircleTimer:GetMilliseconds() >= circletime + 0 then
			...
			if FadeOutTimer ~= nil then
				BlimpAlpha = math.clamp( 255 - (FadeOutTimer:GetSeconds() * 196), 0, 255 )
				CircleAlpha = math.clamp( 150 - (FadeOutTimer:GetSeconds() * 150), 1, 150 )
			...
			Render:FillCircle( self.position, oldsize, LocalPlayer:GetColor() + Color( 0, 0, 0, CircleAlpha) )
			Render:DrawCircle( self.position, oldsize, Color( 255, 255, 255, CircleAlpha) )
		end

		Map.Marker:SetSize( Vector2( Render.Height * 0.027, Render.Height * 0.027 ) )
		Map.Marker:SetAlpha( 0.9 )
		Map.Marker:SetPosition( Map:WorldToScreen( LocalPlayer:GetPosition() ) - 0.5 * Map.Marker:GetSize() )
		Map.Marker:Draw()
		...
		local position = Map:ScreenToWorld( pos )
		...
		Render:DrawText( Vector2( 41, 46 ), txtx, Color.Black, 15 )
		Render:DrawText( Vector2( 41, 61 ), txty, Color.Black, 15 )

		Render:DrawText( Vector2( 40, 45 ), txtx, Color.White, 15 )
		Render:DrawText( Vector2( 40, 60 ), txty, Color.White, 15 )

		Render:DrawText( Vector2( 41, 86 ), MTSetWp, Color.Black, 15 )
		Render:DrawText( Vector2( 40, 85 ), MTSetWp, Color.White, 15 )

		Render:DrawText( Vector2( 41, 106 ), MTPToggle, Color.Black, 15 )
		Render:DrawText( Vector2( 40, 105 ), MTPToggle, Color.White, 15 )

		Render:DrawText( Vector2( 41, 126 ), MTExtract, Color.Black, 15 )
		Render:DrawText( Vector2( 40, 125 ), MTExtract, Color.White, 15 )
	end
