	...
	for player in Server:GetPlayers() do
		if player:GetName() == name then
			if not last then
				...
				if player:GetValue( "Lang" ) == "ENG" then
					player:SendChatMessage( "[Record] ", Color.White, "You won a fantastic wingsuit! Your reward: $500!", Color( 255, 150, 0 ) )
				else
				...
				for p in Server:GetPlayers() do
					if p:GetValue( "Lang" ) == "ENG" then
						p:SendChatMessage( "[Record] ", Color.White, player:GetName() .. " won a fantastic wingsuit and won $500!", Color( 255, 150, 0 ) )
					else
