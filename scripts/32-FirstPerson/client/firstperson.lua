...
function FirstPerson:__init()
	...
	self.bikes = { [80] = true, [27] = true, [4] = true, [83] = true, [32] = true, [47] = true, [21] = true, 
				...
				[36] = true, [75] = true, [12] = true, [75] = true, [16] = true, [45] = true, [19] = true, 
...
function FirstPerson:Active()
	if self.enabled then
		...
		self.enabled = false
		Events:Fire( "CastCenterText", { text = self.off, time = 2, color = Color( 0, 222, 0 ) } )
	else
		...
		Events:Fire( "CastCenterText", { text = self.on, time = 2, color = Color( 0, 222, 0 ) } )
	end
end
